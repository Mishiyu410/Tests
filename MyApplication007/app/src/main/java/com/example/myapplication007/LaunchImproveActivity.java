...
import com.example.myapplication007.adapter.LaunchImproveAdapter;

public class LaunchImproveActivity extends AppCompatActivity {
    // 声明引导页面的图片数组
    private int[] lanuchImageArray = {R.drawable.e,
            R.drawable.fi, R.drawable.s, R.drawable.se, R.drawable.o};
